"""
Training script for the CNNPlanner model.

Usage:
    python3 -m homework.train_cnn_planner.py
"""
...
def train_cnn_planner():
    ...
    train_loader = load_data(
        "drive_data/train",
        transform_pipeline="default",  # Includes image data
    ...
    checkpoint_dir = Path('checkpoints/cnn_planner')
    ...
    # Train for 50 epochs (CNNs with image input often need more training)
    for epoch in range(1, 51):
        ...
        if epoch - best_epoch > 15:
            print(f"Early stopping at epoch {epoch} since no improvement for 15 epochs")
            break
